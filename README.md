...
1.  Pobierz i uruchom aplikację **Visionect Configurator** na swoim komputerze:
    ...
    *   **Windows: Starsza wersja 1.3.10** [VisionectConfigurator2.exe](https://files.visionect.com/VisionectConfigurator2.exe) lub [VC_1.exe](https://files.visionect.com/VC_1.exe) gdy wyświetlacz e-ink niełączy się z nową (Hardware Revision Second generation Visionect Sign 6) niekiedy trzeba adres ip ustawić w [VC_1.exe] a reszta połączenia 1.3.10 
