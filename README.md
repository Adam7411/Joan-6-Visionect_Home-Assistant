![image](https://github.com/user-attachments/assets/22e9de3f-c63b-4afa-b07e-dd65dbcdb8a0)
...
10. Po chwili na ekranie tabletu powinien pojawić się Twój dashboard z Home Assistant. (jesli nie zmień częstotliwość odświeżania** (`Refresh rate`) tylko chwilowo na 2 sekundy aby załadowało nowy dashboard póżniej ustaw swoja waryość)
